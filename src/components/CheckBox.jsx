...
function CheckBox({isCompleted, setIsCompleted, updateTodo, id}) {
  const handleUpdate = () => {
    updateTodo(id)
    setIsCompleted(!isCompleted)
  }
  return (
    <div className="h-6 w-6 lg:h-8 lg:w-8 rounded-full cursor-pointer todo-gradian p-[1px]" onClick={handleUpdate}>
